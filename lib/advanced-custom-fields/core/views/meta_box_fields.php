					...
					<table class="acf_input widefat acf_field_form_table">
						...
						<tr class="conditional-logic" data-field_name="<?php echo $field['key']; ?>">
							...
							<td>
								...
								?>
								<div
									class="contional-logic-rules-wrapper" <?php if ( ! $field['conditional_logic']['status'] ) {
									echo 'style="display:none"';
								} ?>>
									<table
										class="conditional-logic-rules widefat acf-rules <?php if ( count( $field['conditional_logic']['rules'] ) == 1 ) {
