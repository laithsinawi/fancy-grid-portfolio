<ol>
	...
	<li><?php _e('Create page, menu item and include shortcode in page', 'fancy-grid-portfolio'); ?>
		<code>[fgp_portfolio]</code>
	</li>
	<li><?php _e('You can override "Hide Filter Categories" setting in shortcode by using "hide_filters" attribute.', 'fancy-grid-portfolio'); ?><br>
		<?php _e('Example:', 'fancy-grid-portfolio'); ?> <code>[fgp_portfolio hide_filters=1]</code> or <code>[fgp_portfolio hide_filters=0]</code></li>
